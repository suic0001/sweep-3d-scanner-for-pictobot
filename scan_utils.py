...
################################################################################################
##Segment commented below is the origin function to remove deadzone area
...
##############################################################################################
#Here we add a function to remain angular window between 29 to 135 degree
def remain_angular_window(scan, low, high):
    scan.samples[:] = [sample for sample in scan.samples if (
		low < 0.001 * sample.angle and high > 0.001 * sample.angle)]
